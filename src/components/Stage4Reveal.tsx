...
export const Stage4Reveal: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="relative z-10 flex flex-col justify-center items-center w-full min-h-[calc(100vh-5.5rem)] px-6 py-6 max-w-6xl mx-auto select-none"
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl p-6 sm:p-8 md:p-10 rounded-3xl bg-slate-950/90 border-2 border-gold-500/60 backdrop-blur-2xl shadow-[0_0_90px_rgba(212,175,55,0.25)] flex flex-col items-center text-center overflow-hidden"
      >
        ...
        >
          <img
            ...
            className="w-32 h-32 sm:w-40 sm:h-40 md:w-44 md:h-44 object-contain drop-shadow-[0_0_40px_rgba(226,184,87,0.9)] hover:scale-105 transition-transform duration-500"
          />
        </motion.div>
        ...
        >
          ...
          <h4 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-wide text-white">
            {EVENT_CONFIG.chiefGuest.name}
          </h4>

          <div className="flex items-center justify-center space-x-2 text-sm sm:text-base font-extrabold text-amber-400 tracking-wider pt-2">
